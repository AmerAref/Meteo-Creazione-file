...
namespace Meteo.UI
{
    public class LoginOrRegistration
    {
        ...
        public  string AuthenticationOrRegistration()
        {
            ...
            menu = new Menu( queryBuilder,  lang,  null);





            var registationUserInterface = new RegistrationUserInterface(lang);
        ...
        private string Registrartion(RegistrationUserInterface registationUserInterface)
        {
            ...
            registationUserInterface.PrintQuestion();
            ...
            _languageNewAccount = registationUserInterface.SelectLanguage();
            var lenguageSelectedForUnitMeasure = Console.ReadLine();
            _measureUnit = registationUserInterface.SelectUnitOfMeasureFromLanguages(lenguageSelectedForUnitMeasure);
