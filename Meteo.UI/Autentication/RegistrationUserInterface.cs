...
namespace Meteo.Services
{
    public class RegistrationUserInterface
    {
        ...
        public void PrintQuestion()
        {
            if (_lang == "1")
            {
                _menu.SelectQuestionIT();
            }
            else
            {
                _menu.SelectQuestionEN();
            }
        }
        ...
        public string SelectLanguage()
        {
            ...
            if (_lang == "1")
            {
                _menu.SelectLanguageIT();
                languageNewAccount = "it";

            }
            else
            {
                _menu.SelectLanguageEN();
                languageNewAccount = "en";
            }
            return languageNewAccount;


        }
        public string SelectUnitOfMeasureFromLanguages(string selcetLanguage)
