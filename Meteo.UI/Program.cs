    ...
    public static class Program {
        ...
        static void Main (string[] args) {
            ...
            var builder = new ConfigurationBuilder ()
                .AddJsonFile ("/home/amer/Meteo Corretto/app/Meteo-Creazione-file/Meteo.Services/Connection.To.Database/DatabaseConnection.json", optional : false, reloadOnChange : true);
